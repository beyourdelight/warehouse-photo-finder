...
export const dict = {
  th: {
    ...
    codeExists: (n: number) => `รหัสนี้มีในระบบอยู่แล้ว (${n} รูป) — รูปใหม่จะเพิ่มเข้าการ์ดเดิม`,
    takePhoto: "ถ่ายรูป",
  ...
  en: {
    ...
    codeExists: (n: number) => `This code already exists (${n} photo(s)) — new photos will join that card.`,
